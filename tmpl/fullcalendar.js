...
function AgendaEventRenderer() {
	...
	function slotSegHtml(event, seg, className) {
		return "<div class='" + className + event.className.join(' ') + "' title='" + htmlEscape(event.title) + "|" + htmlEscape(event.description) + "<br /><b>" + htmlEscape(event.location) + "</b>' style='position:absolute;z-index:8;top:" + seg.top + "px;left:" + seg.left + "px'>" +
...
function DayEventRenderer() {
	...
	function daySegHTML(segs) { // also sets seg.left and seg.outerWidth
		...
		for (i=0; i<segCnt; i++) {
			...
			html +=
				"<div class='" + className + event.className.join(' ') + "' title='" + htmlEscape(event.title) + "|" + htmlEscape(event.description) + "<br /><b>" + htmlEscape(event.location) + "</b>' style='position:absolute;z-index:8;left:"+left+"px'>" +
					"<a" + (event.url ? " href='" + htmlEscape(event.url) + "'" : '') + ">" +
